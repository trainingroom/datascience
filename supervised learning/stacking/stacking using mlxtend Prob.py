# -*- coding: utf-8 -*-
"""
Created on Tue Apr 24 17:20:30 2018
...
stack_estimator = classifier.StackingClassifier(classifiers=[dt1, knn2, gb3], meta_classifier=lr, use_probas=True) #store_train_meta_features=True,
