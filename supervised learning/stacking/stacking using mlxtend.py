# -*- coding: utf-8 -*-
"""
Created on Tue Apr 24 17:19:24 2018
...
stack_estimator = classifier.StackingClassifier(classifiers=[dt1, knn2, gb3], meta_classifier=lr) #, store_train_meta_features=True)
